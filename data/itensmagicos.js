...
const itensMagicosData = {
    "item": [
        ...
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório Médio",
            descricao: "Bastão. Pode gastar (Ação Padrão, 3 PM) para forçar criaturas em 9m a largar armas e ficarem pasmas (Vontade CD Sab anula). 1/cena. Pode lançar Guardião Divino (custo -1 PM se já a conhece).",
            fonte: "Heróis de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório Médio",
            descricao: "Bastão. Permite lançar Sonho. 1/mês, se já conhece a magia, pode entregar ou roubar um item da pessoa (teste de Vontade oposto para roubar).",
            fonte: "Heróis de Arton"
        },
        {
        ...
        // (Itens de Deuses de Arton - Itens Litúrgicos 2)
        {
            ...
            descricao: "Maior. Meia armadura reforçada (+1) guardiã (+4) de mitral (penalidade -2). Conta como armadura leve para Destreza na Defesa e habilidades (como Evasão).",
        ...
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Varinha arcana poderosa (+2 CD) de madeira Tollon. Se devoto de Wynna: fornece RD 5. Quando lança magia, transfere mana para aliado em alcance curto (1 PM temporário por círculo, máx. custo da magia). 1/dia por aliado.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Menor. Machado de guerra atroz (+2 dano). Se devoto de Thwor: torna-se formidável (+2). Ao entrar em fúria, dano aumenta em um passo. Se Patamar Campeão+, aumenta em mais um passo (dois total).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Espada longa precisa (crit +1). Se devoto de Thyatis: torna-se formidável (+2). Pode gastar 2 PM (cena) para virar plasma vermelho: ataque +4, dano aumenta 2 passos (fogo não letal) e ignora 20 RD.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Se devoto de Thyatis: +1 Sabedoria (após 1 dia). 1/dia, pode rolar novamente um teste de Iniciativa, Percepção ou resistência.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Se devoto de Valkaria: +1 Constituição (após 1 dia) e +5 Fortitude (marcha forçada). Ao fazer investida, recebe 1 PM temporário cumulativo (máx. 3 PM/patamar por dia).",
            fonte: "Deuses de Arton"
        },
        {
        ...
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Vestuário. Se devoto de Wynna: ao lançar magia, recebe +2 PM para aprimoramentos (pode exceder limite). Pode ser usada sobre outras roupas.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Menor. Maça atroz (+2 dano). Se devoto de Megalokk: torna-se formidável (+2) e dano aumenta 2 passos. Se Patamar Campeão+, aumenta mais 2 passos (quatro total).",
            fonte: "Deuses de Arton"
        },
        {
        ...
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Menor. Se devoto de Oceano: 1 PM cria água salgada; 1 PM cone 6m de água (derruba, Ref CD Sab); 2 PM invoca elemental da água (parceiro destruidor/frio ou guardião veterano) por 1 cena.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Tridente pungente (+2 ataque). Se devoto de Oceano: torna-se congelante (+1d6 frio) e formidável (+2). Se mergulhado em água (ação mov.), torna-se magnífico (+4) pela cena.",
            fonte: "Deuses de Arton"
        },
        {
        ...
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Menor. Se devoto de Tanna-Toh: Estudar 1h dobra bônus de treino em perícia (Int/Sab) por 1 dia. 1/aventura, recebe 1d3 pergaminhos que poderia criar.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Conta como Veste de Seda aprimorada (+1) cravejada de gemas (+2 Enganação). Total +2 Enganação/Reflexos. Se devoto de Tenebra: Pode gastar (Ação Padrão, 5 PM) para ficar invisível (veja magia Invisibilidade) até o fim da cena ou atacar.",
            fonte: "Deuses de Arton"
        },
        // (Itens de Deuses de Arton - Itens Litúrgicos 1)
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Espada longa certeira (+1 ataque). Se devoto de Khalmyr: pode gastar (Ação Mov.) para ler versículo e fazer teste de Religião (CD 20). Sucesso: torna-se formidável (+2). Por 10+: gera efeito Oração. Por 20+: torna-se magnífica (+4). Dura pela cena.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Armadura/Escudo",
            descricao: "Média. Armadura completa polida (+5 Def 1ª rodada) e reforçada (+1). Se devoto de Khalmyr: torna-se defensora (+2). Quando criatura ataca, pode gastar 2 PM para deixá-la pasma (1 rodada, 1/cena) e frustrada (Vontade CD Sab reduz para frustrada). Se Patamar Campeão+, torna-se guardiã (+4).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Panela de ferro. Gastando 1h e T$ 5 (Ofício Cozinheiro CD 15), cria comida para 5 pessoas. Comensais recebem +2 em TR por 1 dia (devotos de Lena recebem +10 PV temp.). Pode acumular com Prato Especial (+5 CD).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Alabarda certeira (+1 ataque) e precisa (crit +1). Se devoto de Lin-Wu: torna-se formidável (+2) e fornece +5 Iniciativa. Se for o primeiro a agir, recebe 2 PM temporários por nível (cena).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Katana precisa (crit +1) e pungente (+2 ataque). Se devoto de Lin-Wu: torna-se formidável (+2), ignora imunidade a crítico de lefeu. Ao derrotar lefeu, cura 2d8+2 PV e recebe +2 dano (cena). Se Patamar Campeão+, torna-se magnífica (+4).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Instrumento musical aprimorado (+1). Se treinado em Atuação, pode gastar (Ação Padrão, 1 PM) para dar +2 em perícias para aliados em alcance médio (cena). Se devoto de Marah e usar Música, ativa como ação livre.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Conta como Veste de Seda aprimorada (+1 Reflexos). Se devoto de Marah: fornece +1 Carisma (após 1 dia) e +2 Defesa (cumulativo).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Colar. Fornece +2 Intimidação e -2 Diplomacia. Se devoto de Megalokk: fornece +2 em ataque e dano com armas naturais.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Menor. Machado de batalha certeiro (+1 ataque) e cruel (+1 dano). Se devoto de Arsenal: torna-se formidável (+2). Ao fazer investida, recebe 1 PM temporário cumulativo (máx. = Sabedoria/dia).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Alfange maciço (crit +1, -2 ataque, 2d6 dano). Se devoto de Azgher: pode gastar (Ação Completa) para sacrificar ouro. Remove penalidade e dá bônus (dia): T$ 10 (+2), T$ 100 (+3), T$ 500 (+4), T$ 1.000 (+5).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Cimitarra pungente (+2 ataque). Se devoto de Azgher: torna-se flamejante (+1d6 fogo) e formidável (+2). Sob luz do sol, dano da bola de fogo (flamejante) aumenta para 12d6. Se Patamar Campeão+, torna-se precisa e magnífica (+4).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Menor. Adaga. Se devoto de Hyninn: torna-se formidável (+2). Na 1ª vez na cena que passar em Enganação ou Furtividade, recebe +5 em um teste à escolha (cena). Se Patamar Campeão+, torna-se magnífica (+4).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Média. Se devoto de Hyninn: Pode gastar (Ação Padrão) para armar o cubo em espaço curto (invisível). 1º inimigo a entrar sofre 10d8 corte (Ref CD Int reduz). Dados '1' ou '8' explodem (rolam de novo). Pode ser percebido com Investigação (CD 30 + Int).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Média. Lança maciça (crit +1). Se devoto de Kally: +1 ataque/dano e +1d10 dano elemental (ácido/eletricidade/fogo/frio) à escolha. Bônus aumenta +1 a cada nível (máx +6). Se ficar 1 mês longe, bônus cai.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Maior. Acessório de ossos. Fornece +4 Intimidação e -2 Diplomacia. Se devoto de Kally: fornece +2 Força, +2 Carisma e +2 na CD de todas as habilidades.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Maior. Item vestido (cinta com anzóis). Reduz PV máx em 1/nível. Fornece +1 em todos os testes (cumulativo). Se devoto de Aharadak: bônus +2. Se Patamar Campeão+, aumenta PM máx em +1/nível.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Maior. Baú com coração. Se devoto de Aharadak sacrificar criatura inteligente, item absorve dano/condições do devoto (até 100 PV e 3 condições). Funciona à distância.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Menor. Tiara. Se devoto de Allihanna: +1 Sabedoria (após 1 dia) e magias com efeitos numéricos variáveis recebem +1 por dado.",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Arma Mágica",
            descricao: "Menor. Bordão. Se devoto de Allihanna: torna-se formidável (+2) e fornece +2 Defesa ao ar livre (cumulativo). Se Patamar Campeão+, torna-se magnífico (+4).",
            fonte: "Deuses de Arton"
        },
        {
            ...
            categoria: "Item Mágico",
            tipo: "Acessório",
            descricao: "Maior. Ferramenta de Guerra aprimorada (+2). Se devoto de Arsenal: pode gastar (Ação Completa, CD 20 Guerra). Sucesso: bônus em Guerra aplica a todos os testes de perícia de aliados em alcance curto (cena). Sucesso por 20+: aliados recebem ação padrão extra.",
            fonte: "Deuses de Arton"
        }
